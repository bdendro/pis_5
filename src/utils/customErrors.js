...
export class InternalServerError extends AppError {
  constructor(message = 'Internal server error', statusCode = 500, innerError = null) {
...
export class ApiUnavailableError extends ExternalServiceError {
  constructor(serviceName = 'API', innerError = null, message = 'Service temporarily unavailable') {
